...
Tsl2561ControlRegister::Tsl2561ControlRegister()
	: m_powerControl{Tsl2561PowerControl::POWER_DOWN} {}

Tsl2561ControlRegister::Tsl2561ControlRegister(uint8_t bits)
	: m_powerControl{static_cast<Tsl2561PowerControl>(bits)} {}
...
void Tsl2561ControlRegister::SetPowerControl(Tsl2561PowerControl powerControl)
{
		m_powerControl = powerControl;
}
